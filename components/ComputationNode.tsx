...
export const ComputationNode = forwardRef<HTMLTextAreaElement, ComputationNodeProps>(
    ({computationNodeState, hasInput, hasOutput, running, instructionChangeHandler}, ref) => {
        const MAX_LINES = 15;
            ...
            <div>
                ...
                <div className="flex">
                    <div className="relative">
                          <textarea value={code} disabled={running} onChange={handleChange} rows={MAX_LINES} ref={ref}
